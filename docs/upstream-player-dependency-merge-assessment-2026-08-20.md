...
- 2026-09-16 P2-4第9.19节完成新日志32与跨项目描述符性能方案评审：05:28诊断包已生效，2429条去重事件与在线快照一致；604次warm bind均值34.675ms/线程CPU0.980ms，push明确不支持，仍有未归因等待。已读Vulkan规范、ANGLE/Filament/libplacebo/FFmpeg/GStreamer/Mesa、Arm/NVIDIA及论文/论坛/PR，推荐先做“相同描述符内容复用+每帧fresh bind/record”单变量候选，无效后最小外部图像对照，再有条件评审graphics暂存。仅文档评审，A/B/C未实施，起播与整体电视实时性能未关闭。基线`57211803d507ab1b6b6a0ee02c626a7f5909eebc`，guard `P2-4-fel-descriptor-review`，104个既有脏文件保护。唯一下一步：交付[9.19方案](P2-4-mpv-android-fel.md#919-新日志32描述符绑定等待的跨项目最佳实践评审2026-09-16)，下一实施单元限定为A及像素/电视性能裁决。
...
| P2 子阶段 | `P2-4` | MPV/native/App | Android BL 硬解 + EL 软解 + GPU FEL 重建，新增手动选择项 | 新日志32确认TV64诊断包生效、bind持续高耗时且push不支持；9.19跨项目最佳实践方案完成，内容缓存单变量候选待实施；起播与整体电视实时性能未验收 | [P2-4-mpv-android-fel.md](P2-4-mpv-android-fel.md) |
