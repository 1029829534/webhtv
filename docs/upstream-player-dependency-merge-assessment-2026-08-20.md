...
| ---: | --- | --- | --- | --- | --- |
| 研究完成 | `E4-LIBASS` | Exo/字幕 | 独立实现 ASS 特效字幕：libass、Media3 接线及跨播放器开源参考 | 2026-09-14 已核验 libass-android/Jellyfin 及本地 MPV SurfaceView/EGL；建议先做复用字幕承载的外挂 ASS 原型，尚未授权实施；与既有 E4-2 Cue 任务分开 | [E4-LIBASS-exo-ass-rendering.md](E4-LIBASS-exo-ass-rendering.md) |
